...
\Anexo{Manuales del Sistema}

Para facilitar la adopción, despliegue y futuro mantenimiento del Asistente Virtual Multimodal, se han elaborado tres manuales especializados que documentan exhaustivamente el ciclo de vida del software. Estos manuales se encuentran alojados, versionados y disponibles públicamente en el repositorio oficial de GitHub del proyecto.

A continuación, se proporcionan los enlaces directos a cada documento:

\begin{itemize}
    \item \textbf{Manual de Implementación:} Guía paso a paso para configurar el entorno de ejecución, instalar dependencias, configurar Docker, y levantar los servicios backend y frontend. \\
    \url{https://github.com/EmilioEJ/Virtual_Asistant/blob/main/Manuales/Implementacion/Manual_Implementacion.pdf}
    
    \item \textbf{Manual Técnico:} Documentación dirigida a desarrolladores y mantenedores. Contiene la arquitectura del sistema, el diseño del motor RAG, la estructura de la base de datos ChromaDB y la lógica de integración de APIs. \\
    \url{https://github.com/EmilioEJ/Virtual_Asistant/blob/main/Manuales/Tecnico/Manual_Tecnico.pdf}
    
    \item \textbf{Manual de Usuario:} Guía instructiva e ilustrada para el usuario final (estudiantes e invitados), explicando el uso de la interfaz gráfica, comandos de voz y la navegación por el sistema. \\
    \url{https://github.com/EmilioEJ/Virtual_Asistant/blob/main/Manuales/Usuario/Manual_Usuario.pdf}
\end{itemize}