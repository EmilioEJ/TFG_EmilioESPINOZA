...
\textcolor{red}{Aunque participaron 13 estudiantes, algunas preguntas no fueron respondidas por la totalidad de participantes; por esta razón, el número válido de respuestas varía entre determinadas variables. En cada gráfico se conserva el número efectivo de respuestas registrado por el formulario (e.g., n=12, n=11).}
