...
\begin{figure}[p]
  \centering
  \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth,height=0.98\textheight,keepaspectratio]{Logos/FInal_Diagrama_Clases_cropped.pdf}}
  \caption{Diagrama de Clases del Sistema (Arquitectura Completa y Flujo Circular).}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=1.0\textwidth]{Logos/3nuevo_diagrama_estados.png}
...
\begin{itemize}
    \item \textbf{Speech-to-Text (STT):} Transcribe el audio del usuario a texto natural en español utilizando un procesamiento en \textit{backend} (Whisper-v3 vía API), desacoplado del navegador para asegurar compatibilidad y baja latencia.
