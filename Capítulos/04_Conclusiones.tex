...
\begin{itemize}
    ...
    \item \textbf{Diseño de la Arquitectura Descentralizada:} El diseño del sistema bajo un modelo cliente-servidor demostró ser factible. La integración de WebSockets permitió delegar el procesamiento de fotogramas al navegador cliente, previniendo interbloqueos en el servidor centralizado y reduciendo el consumo de recursos de CPU al aplicar métodos de visión artificial ligeros (análisis de caja delimitadora).
...
\begin{itemize}
    ...
    \item \textbf{Control de Costos (OPEX):} La utilización continua de modelos generativos (2500 tokens de contexto promedio por interacción) conlleva un costo operativo que puede escalar exponencialmente con el despliegue a toda la universidad. Se sugiere implementar políticas de \textit{rate limiting} (cuotas máximas de consultas por estudiante al día) para mantener la sostenibilidad del servicio de orientación.
\end{itemize}
